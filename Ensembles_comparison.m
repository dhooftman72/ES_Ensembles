...
ImprovementValues.Full.Yrho = dataset(NaN,'Varnames',(genvarname({[char(EnsembleArrayTxt(1)),'vs',char(EnsembleArrayTxt(8))]})));
ImprovementValues.Default.Ydevi = dataset(NaN,'Varnames',(genvarname({[char(EnsembleArrayTxt(1)),'vs',char(EnsembleArrayTxt(2))]})));
ImprovementValues.Full.Ydevi = dataset(NaN,'Varnames',(genvarname({[char(EnsembleArrayTxt(1)),'vs',char(EnsembleArrayTxt(8))]})));
